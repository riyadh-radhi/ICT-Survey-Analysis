`########################
# Programming SKILLS Knowledge Source
#########################
rm(list = ls())
...
df |>
  select(Prog_selfStudy,Prog_college,
...
# Plot Parameters ---------------------------------------------------------
glue("Programming Skills Knowledge Source") |> 
  str_to_title() -> title
...
ggsave(filename = glue("Programming_skills_knowledge_source_CUTSAMPLE.png"),
